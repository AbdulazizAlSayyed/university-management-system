...
export const courses = [
  { id: 'c-cs101', code: 'CS101', name: 'Introduction to Programming', description: 'Fundamentals of programming using Python: variables, control flow, functions, and problem solving.', credits: 3, capacity: 40, professorId: 'u-prof-1', semester: 'Fall 2026', schedule: 'Mon & Wed · 09:00–10:30', room: 'Hall A-101', color: 'bg-brand-500', status: 'active' },
  { id: 'c-cs201', code: 'CS201', name: 'Data Structures & Algorithms', description: 'Arrays, linked lists, trees, graphs, sorting and searching, complexity analysis.', credits: 4, capacity: 35, professorId: 'u-prof-1', semester: 'Fall 2026', schedule: 'Tue & Thu · 11:00–12:30', room: 'Hall B-204', color: 'bg-emerald-500', status: 'active' },
  { id: 'c-cs310', code: 'CS310', name: 'Full-Stack Web Development', description: 'Building production web apps with the MERN stack: MongoDB, Express, React, Node.', credits: 3, capacity: 30, professorId: 'u-prof-1', semester: 'Fall 2026', schedule: 'Mon & Wed · 14:00–15:30', room: 'Lab C-12', color: 'bg-indigo-500', status: 'active' },
  { id: 'c-cs301', code: 'CS301', name: 'Database Systems', description: 'Relational and NoSQL databases, data modeling, SQL, indexing, transactions.', credits: 3, capacity: 35, professorId: 'u-prof-2', semester: 'Fall 2026', schedule: 'Tue & Thu · 09:00–10:30', room: 'Hall A-105', color: 'bg-rose-500', status: 'active' },
  { id: 'c-cs220', code: 'CS220', name: 'Operating Systems', description: 'Processes, threads, scheduling, memory management, file systems, concurrency.', credits: 4, capacity: 30, professorId: 'u-prof-2', semester: 'Fall 2026', schedule: 'Mon & Wed · 11:00–12:30', room: 'Hall B-201', color: 'bg-amber-500', status: 'active' },
  { id: 'c-math201', code: 'MATH201', name: 'Linear Algebra', description: 'Vectors, matrices, determinants, eigenvalues, and linear transformations.', credits: 3, capacity: 50, professorId: 'u-prof-3', semester: 'Fall 2026', schedule: 'Tue & Thu · 14:00–15:30', room: 'Hall D-300', color: 'bg-sky-500', status: 'active' },
  { id: 'c-cs330', code: 'CS330', name: 'Software Engineering', description: 'Software development life cycle, agile, testing, design patterns, project management.', credits: 3, capacity: 40, professorId: 'u-prof-4', semester: 'Fall 2026', schedule: 'Fri · 09:00–12:00', room: 'Hall A-110', color: 'bg-violet-500', status: 'active' },
  { id: 'c-cs410', code: 'CS410', name: 'Introduction to Machine Learning', description: 'Supervised and unsupervised learning, regression, classification, neural networks.', credits: 4, capacity: 25, professorId: 'u-prof-3', semester: 'Fall 2026', schedule: 'Wed & Fri · 13:00–14:30', room: 'Lab C-15', color: 'bg-teal-500', status: 'active' },
]
